...
| `README.md` | • Features bullet (diagram count)<br>• `fig()` call list in API reference<br>• Full option table + example for the new type<br>• Markdown string syntax section (new `<details>` block in the `fig(input)` section) |
