...
export const metadata: Metadata = {
  ...
  description: 'Generate clean, self-contained SVG diagrams from a markdown string. 12 diagram types, zero coordinates, AI-friendly.',
};
...
const FEATURES = [
  ...
  },
  {
    ...
    description: 'Flow, tree, arch, sequence, quadrant, gantt, state, ER, timeline, swimlane, bubble chart, and radar chart.',
  },
  {
    icon: '✍️',
