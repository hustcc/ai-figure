...
export const metadata: Metadata = {
  ...
  description: 'Generate clean, self-contained SVG diagrams from a markdown string. 13 diagram types, zero coordinates, AI-friendly.',
};
...
const FEATURES = [
  ...
  },
  {
    ...
    description: 'Flow, tree, mindmap, arch, sequence, quadrant, gantt, state, ER, timeline, swimlane, bubble chart, and radar chart.',
  },
  {
    icon: '✍️',
