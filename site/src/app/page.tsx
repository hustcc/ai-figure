...
export const metadata: Metadata = {
  ...
  description: 'Generate clean, self-contained SVG diagrams from a markdown string. 14 diagram types, zero coordinates, AI-friendly.',
};
...
const FEATURES = [
  ...
  {
    icon: '📐',
    title: '14 diagram types',
    description: 'Flow, tree, mindmap, arch, sequence, quadrant, gantt, state, ER, timeline, swimlane, bubble chart, radar chart, and network.',
  },
  {
    icon: '✍️',
