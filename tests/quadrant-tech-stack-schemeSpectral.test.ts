...
it('quadrant chart — tech stack adoption: effort vs value, schemeSpectral palette', () => {
  const svg = fig({
    figure: 'quadrant',
    ...
    palette: 'schemeSpectral',
  });
  matchSvgSnapshot('quadrant-tech-stack-schemeSpectral', svg);
});
